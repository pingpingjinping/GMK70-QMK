...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        MOR_4,     KC_LCTL,  MO(_FL),  KC_LALT,            KC_SPC,                                 KC_SPC,             KC_RALT,  KC_RGUI,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  _______,  KC_NO,    TO(_MBL),  _______,  _______,  _______,                      KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,    RGB_SAD,  RGB_SAI,             KC_END, 
    ...
    [_MBL] = LAYOUT( /* Base */
        ...
        MOR_2,   KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,                         KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,         
        MOR_3,   KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,               KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,    KC_DEL,
        MOR_4,   KC_LCTL,  MO(_MFL), KC_LGUI,            KC_SPC,                                 KC_SPC,            KC_RGUI,  KC_RALT,            KC_LEFT,  KC_DOWN,  KC_RGHT),

    [_MFL] = LAYOUT( /* Base */
        _______,  _______, _______,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,              KC_F6,    KC_F7,    KC_F8,   KC_F9,     KC_F10,  KC_F11,    KC_F12,   EE_CLR,
        _______,  RGB_MOD,  KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   _______,                      KC_PSCR,  KC_SCRL,  KC_PAUSE, _______, _______, RGB_HUD,   RGB_HUI,  RL_MOD,  
        _______,  _______,  TO(_BL),  KC_NO,    _______,  _______,  _______,                      KC_HOME,  KC_END,   KC_PGUP, KC_PGDN, RGB_SAD, RGB_SAI,             KC_END, 
